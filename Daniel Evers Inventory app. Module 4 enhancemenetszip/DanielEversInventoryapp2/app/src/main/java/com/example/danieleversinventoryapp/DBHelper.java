...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if (oldVersion < 4) {
            db.execSQL("ALTER TABLE inventory ADD COLUMN price REAL DEFAULT 0.0");
        }
    }
    ...
    public boolean addItem(String name, int quantity, String condition, boolean willingToTrade, double price) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
    ...
    public boolean updateItem(int id, String name, int quantity, String condition, boolean willingToTrade, double price) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
